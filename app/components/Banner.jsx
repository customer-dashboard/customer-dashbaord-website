                                ...
                                <div className="shopify_video banner_video hero-banner-image">
                                    {
                                        showComponents == 'New Customer Account' ?
                                         <Image src="https://mandasa1.b-cdn.net/CustLo/Home%20Page%20Images/main%20banner%20image.png" alt="Shopify new customer account hero banner image" title="Shopify new customer account"/>
                                        :
                                        showComponents == 'Classic Customer Account' ?
                                        <Image src="https://mandasa1.b-cdn.net/CustLo/Home%20Page%20Images/lagecy%20account%20page.png"/>
                                        :
