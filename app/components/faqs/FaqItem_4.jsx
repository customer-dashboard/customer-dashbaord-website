                                ...
                                <div className="accordian_index_2_data accordian_index_data">
                                        <div className="accordian_index_2_title">
                                         ...
                                         <div className="manu_builder_list_steps">
                                          ...
                                          <LazyLoadedImage src="https://mandasa1.b-cdn.net/customer-dashbaord-pro/top-ordered-products-step-1.gif" alt="faq-gif" />
                                        </div>
                                        <div>
                                          <br></br>
                                        ...
                                        <LazyLoadedImage src="https://mandasa1.b-cdn.net/customer-dashbaord-pro/top-ordered-products-step-2.gif" alt="faq-gif" />
                                        </div>
