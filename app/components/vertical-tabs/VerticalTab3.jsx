  ...
  return (
    ...
    <div className="vertical-tabs">
      ...
      <div class="plugin new_account_tabs_features account_potential mb-5">
        <h2 className='font-alverata-normal'><span className='gradient-text'>Power up Shopify accounts</span> with Custlo</h2>
                ...
                return (
                  <Nav.Item key={i}>
                    <Nav.Link className={item.tClassName} eventKey={item.tEventKey}>
                        <div className="v-tab-h-container align-items-center gap-3 d-flex c-fff">
