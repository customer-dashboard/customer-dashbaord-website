...
function VerticalTab3() {
  ...
  return (
    ...
    <div className="vertical-tabs">
      ...
      <div class="plugin new_account_tabs_features account_potential mb-4"><h2>Discover the Power of <span className='uniqu_color'>Shopify's New Customer Account</span> Features With Customer Dashboard Pro : MT</h2>
      <p className='mt-3'>Enhance the customer experience with powerful tools, engaging widgets, and innovative features designed exclusively for <span>Shopify's new customer accounts.</span></p></div>
