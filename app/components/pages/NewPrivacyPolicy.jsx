      ...
      <section className='privacy-policy-page-manu'>
        <div className='pages-container page-main-section container'>
          <div className='privacy-policy-page-container'>
            <div className='privacy-policy-page-title manu-page-title'>
              <h1 className='page-title'>PRIVACY POLICY</h1>
            </div>
            <div className='page-content privacy-policy-page-content'>
              <div className="update-date">Last updated: Aug 18, 2024</div>
              <p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
              <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</p>
              <h2 className='page-manu-h2'>Interpretation and Definitions</h2>
              <h3 className='page-manu-h3'>Interpretation</h3>
              <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
              <h3 className='page-manu-h3'>Definitions</h3>
              ...
              <ul className='list-content'>
                ...
                <li>
                  <p>
                    ...
                    &nbsp;  (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to <span>Mandasa Technologies, Gandhi Choraha, Mandsaur 458001, INDIA.</span>
                  </p>
                </li>
                ...
                {/* <li>
                  <p>
                    ...
                    &nbsp;  refers to New Customer Dashboard Pro and it’s app, accessible from &nbsp;
