...
import {
  orderTrackingWidget,
  customFieldData,
} from "../middleware/new-customer-account/ImageWithText";
import {
  HomePageFeatures,
  homePageHeadings,
} from "~/middleware/FeaturedContentDataM";
...
import CustomSectionStyle from "../styles/CustomSection.css";
...
export const meta = () => {
  return [
    {
      title:
        "Customize Shopify Customer Account Pages | Customer Dashboard Pro : MT",
    },
    {
      name: "description",
      content:
        "Looking to Take Control Manage and Customize of Your Shopify Customer Account Pages? Look No Further Than Customer Dashboard Pro. Easily Manage and Customize Your Shopify Account Pages With Ease.",
    },
    {
      name: "keywords",
      content:
        "Shopify Customer Accounts Page,customer account shopify, Customer Account Page, Customer Dashboard Pro Account Page, Shopify Account Page",
    },
    {
      property: "og:title",
      content:
...
export const links = () => [
  ...
  { rel: "stylesheet", href: CustomSectionStyle },
];
