...
export const CustomerSolutionTop = {
  ...
  BannerImage:
    "https://mandasa1.b-cdn.net/customer%20dashboard%20website/new%20customer%20account%20images/Blogs/Supercharge%20(2).png",
  SubHeading:
    "In the current highly competitive e-commerce landscape, buyer experience is everything! Modern Shopify owners know the relevance of offering a seamless, enjoyable shopping experience to boost conversations and foster long-term customer relationships. ",
  BannerButton: "Install Now",
  Tag: "CustomerInsights",
};
...
export const BoostCustomerAccountTopSectionData = {
  ...
  SubHeading:
    "Unlock the potential of personalized experiences by integrating a customer accounts app.Increase customer retention, streamline checkout processes, and enhance engagement to drive more conversions. ",
  BannerButton: "Install Now",
  Tag: "CustomerInsights",
};
...
export const HistoryEssentailForCustomer = {
  ...
  Heading: `Why <span className = "product-name">Customer </span>Order History Matters for Your Store’s Success? `,
  BannerImage:
