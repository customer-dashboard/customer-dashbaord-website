export const customFieldData = [
    {
        "title":"Customer Account Pro: MT - Simplify Profile Fields for Shopify's",
        "titleColor":"New Customer Accounts",
        "subTitle":"Customizable Profile Fields for In-Depth Customer Information",
        "description":"Upgrade Shopify ‘New Customer Accounts’ with Customer Account Pro: MT—collect more data, build profiles, and boost revenue with personalization.",
        "buttonUrl":"https://apps.shopify.com/customer-dashboard-pro",
        "button":true,
        "imageAlt":"profile fields in new customer account with customer account Pro: MT",
...
export const orderTrackingWidget = [
    {
        ...
        "description":"Upgrade Shopify’s ‘New Customer Accounts’ with Customer Account Pro: MT to track orders seamlessly and boost satisfaction with interactive maps.",
        "buttonUrl":"https://apps.shopify.com/customer-dashboard-pro",
        "button":true,
        "imageAlt":"order tracking map and graph with customer account pro -MT ",
