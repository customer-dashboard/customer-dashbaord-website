        ...
        <>
            ...
            <Navbar expand="lg" className="nav_navbar">
                ...
                <Navbar.Toggle aria-controls="basic-navbar-nav" className="toggle_btn"/>
                    <Navbar.Brand href="#home" className="customer_logo">
                        <Image src={logo}></Image>
                    </Navbar.Brand>
                    <Button variant="primary" className="btn header_btn btn-md ml-15 d-none-min-991">View Demo</Button>
                    ...
                    <Button variant="primary" className="btn header_btn btn-md ml-15 d-none-991">View Demo</Button>
                </Container>
            </Navbar>
        </>
    );
